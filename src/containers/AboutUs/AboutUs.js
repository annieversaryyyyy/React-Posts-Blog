        ...
        <div>
            <section className="u-align-center u-clearfix u-section-3" id="carousel_09a3">
                <div className="u-clearfix u-sheet u-valign-middle-md u-sheet-1">
                    ...
                    <h1 className="u-custom-font u-heading-font u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1"> What
                        do our users say?
                    </h1>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p className="u-text u-text-default u-text-grey-50 u-text-2">Sample text. Click to
                                        select the text box. Click again or double click to start editing the text.</p>
                                    <div alt="" className="u-image u-image-circle u-image-1" data-image-width="206"
                                         data-image-height="206"></div>
                                    <h5 className="u-text u-text-default u-text-3">Nat Reynolds</h5>
                                    <h6 className="u-text u-text-default u-text-grey-50 u-text-4">Chief Accountant</h6>
                                </div>
                            </div>
                            <div
                                ...
                                <div
                                    ...
                                    <p className="u-text u-text-default u-text-grey-50 u-text-5">Sample text. Click to
                                        select the text box. Click again or double click to start editing the text.</p>
                                    <div alt="" className="u-image u-image-circle u-image-2" data-image-width="206"
                                         data-image-height="206"></div>
                                    <h5 className="u-text u-text-default u-text-6">Celia Almeda</h5>
                                    <h6 className="u-text u-text-default u-text-grey-50 u-text-7">Secretary</h6>
                                </div>
                            </div>
                            <div
                                ...
                                <div
                                    ...
                                    <p className="u-text u-text-default u-text-grey-50 u-text-8">Sample text. Click to
                                        select the text box. Click again or double click to start editing the text.</p>
                                    <div alt="" className="u-image u-image-circle u-image-3" data-image-width="626"
                                         data-image-height="417"></div>
                                    <h5 className="u-text u-text-default u-text-9">Bob Roberts</h5>
                                    <h6 className="u-text u-text-default u-text-grey-50 u-text-10">Sales Manager</h6>
                                </div>
                            </div>
                        </div>
                    </div>
